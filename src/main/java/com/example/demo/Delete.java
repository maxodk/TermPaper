...
public class Delete implements Initializable
{
    ...
    public void DeleteEquip(ActionEvent event) throws IOException
    {
        IdList.clear();
        Select select = new Select();
        String login = select.SelectLogin();
        ...
        {
            root = FXMLLoader.load(getClass().getResource("DeleteEquip.fxml"));
            stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            scene = new Scene(root);
    ...
    public void DeleteWeapon(ActionEvent event) throws IOException
    {
        IdList.clear();
        Select select = new Select();
        String login = select.SelectLogin();
        ...
        {
            root = FXMLLoader.load(getClass().getResource("DeleteWeapon.fxml"));
            stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            scene = new Scene(root);
    ...
    {
        Select select = new Select();
        ObservableList<Helmet> HelmetList = select.KnightHelmetList(KnightID);
        ObservableList<Breastplate> BreastplateList = select.KnightBreastplateList(KnightID);
        ObservableList<Boots> BootsList = select.KnightBootsList(KnightID);
        ObservableList<Shield> ShieldList = select.KnightShieldList(KnightID);
    ...
    {
        Select select = new Select();
        ObservableList<Bow> BowList = select.KnightBowList(KnightID);
        ObservableList<HeavyWeapon> HeavyWeaponList = select.KnightHeavyWeaponList(KnightID);
        ObservableList<Spear> SpearList = select.KnightSpearList(KnightID);
        ObservableList<Sword> SwordList = select.KnightSwordList(KnightID);
    ...
    public void DeleteHelmet(ActionEvent event) throws IOException
    {
        int Id = HelmetView.getSelectionModel().getSelectedIndex();
        Select select = new Select();
        String login = select.SelectLogin();
        double money = select.GetKnightMoney(KnightID,login);
        database.Delete delete = new database.Delete();
        ...
        if(Id >= 0)
        {
            ...
            {
                money += select.GetKnightHelmetMoney(KnightID, login);
                delete.KnightHelmet(KnightID,login);
    ...
    public void DeleteBreastplate(ActionEvent event) throws IOException
    {
        ...
        if(Id >= 0)
        {
            ...
            {
                money += select.GetKnightBreastplateMoney(KnightID, login);
                delete.KnightBreastplate(KnightID,login);
                Knight knight = select.GetKnight(KnightID,login);
                update.UpdateKnightMoney(login,money,knight);
            }
        }
    }
    public void DeleteBoots(ActionEvent event) throws IOException
    {
        ...
        if(Id >= 0)
        {
            ...
            {
                money += select.GetKnightBootsMoney(KnightID, login);
                delete.KnightBoots(KnightID,login);
                Knight knight = select.GetKnight(KnightID,login);
                update.UpdateKnightMoney(login,money,knight);
            }
        }
    }
    public void DeleteShield(ActionEvent event) throws IOException
    {
        ...
        if(Id >= 0)
        {
            ...
            {
                money += select.GetKnightShieldMoney(KnightID, login);
                delete.KnightShield(KnightID,login);
                Knight knight = select.GetKnight(KnightID,login);
                update.UpdateKnightMoney(login,money,knight);
            }
        }
    }
    public void DeleteBow(ActionEvent event) throws IOException
    {
        ...
        if(Id >= 0)
        {
            ...
            {
                money += select.GetKnightBowMoney(KnightID, login);
                delete.KnightBow(KnightID,login);
                Knight knight = select.GetKnight(KnightID,login);
                update.UpdateKnightMoney(login,money,knight);
            }
        }
    }
    public void DeleteHeavyWeapon(ActionEvent event) throws IOException
    {
        ...
        if(Id >= 0)
        {
            ...
            {
                money += select.GetKnightHeavyWeaponMoney(KnightID, login);
                delete.KnightHeavyWeapon(KnightID,login);
                Knight knight = select.GetKnight(KnightID,login);
                update.UpdateKnightMoney(login,money,knight);
            }
        }
    }
    public void DeleteSpear(ActionEvent event) throws IOException
    {
        ...
        if(Id >= 0)
        {
            ...
            {
                money += select.GetKnightSpearMoney(KnightID, login);
                delete.KnightSpear(KnightID,login);
                Knight knight = select.GetKnight(KnightID,login);
                update.UpdateKnightMoney(login,money,knight);
            }
        }
    }
    public void DeleteSword(ActionEvent event) throws IOException
    {
        ...
        if(Id >= 0)
        {
            ...
            {
                money += select.GetKnightSwordMoney(KnightID, login);
                delete.KnightSword(KnightID,login);
                Knight knight = select.GetKnight(KnightID,login);
                update.UpdateKnightMoney(login,money,knight);
            }
        }
